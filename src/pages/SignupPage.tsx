      ...
      <div className="relative flex min-h-screen items-center justify-center bg-surface px-4">
        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="card p-8 text-center">
            ...
            <p className="mt-2 break-all font-semibold text-ink-950">
              {email.trim().toLowerCase()}
            </p>

            <p className="mt-4 text-sm leading-6 text-ink-500">
              Please confirm your email address before signing in. After
              confirmation, return to Skillora AI and sign in to continue with
              your student profile and onboarding.
            </p>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="card p-8">
          ...
          <p className="mt-1.5 text-ink-500">
            Create your account first. We'll ask for your student details
